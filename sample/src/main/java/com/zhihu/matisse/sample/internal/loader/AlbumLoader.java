 ...
 */
package com.zhihu.matisse.sample.internal.loader;
...
public class AlbumLoader extends CursorLoader {
  ...
  public static CursorLoader newInstance(Context context, @SourceType.Type int type) {
    String selection;
    String[] selectionArgs;

    switch (type) {
      case SourceType.TYPE_IMAGE:
        selection = SELECTION_FOR_SINGLE_MEDIA_TYPE;
        selectionArgs = getSelectionArgsForSingleMediaType(
            MediaStore.Files.FileColumns.MEDIA_TYPE_IMAGE);
        break;
      case SourceType.TYPE_VIDEO:
        selection = SELECTION_FOR_SINGLE_MEDIA_TYPE;
        selectionArgs = getSelectionArgsForSingleMediaType(
