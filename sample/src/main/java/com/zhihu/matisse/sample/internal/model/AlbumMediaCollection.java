 ...
 */
package com.zhihu.matisse.sample.internal.model;
...
import com.zhihu.matisse.sample.internal.loader.AlbumMediaLoader;
...
public class AlbumMediaCollection implements LoaderManager.LoaderCallbacks<Cursor> {
  ...
  public Loader<Cursor> onCreateLoader(int id, Bundle args) {
    ...
    return AlbumMediaLoader.newInstance(context, album,
        album.isAll() && args.getBoolean(ARGS_ENABLE_CAPTURE, false), mType);
  }
